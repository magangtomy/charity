                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <button type="button" class="close" on:click={handleCloseModal} data-dismiss="modal" aria-label="Close">
            ...
            {/if}
                <div class="xs-popular-item xs-box-shadow">
                    <div class="xs-item-header">
                        ...
                        <img src="{charity.thumnail}" alt="charity thumnail" />

                        <div class="xs-skill-bar">
                            <div class="xs-skill-track">
                                <p><span class="number-percentage-count number-percentage" data-value=""
                                        data-animation-duration="3500">{calculateFunded(charity.pladged, charity.target)}</span>%</p>
                            </div>
                        </div>
                    ...
                    <div class="xs-item-content">
                        ...
                        <ul class="xs-list-with-content" style='font-size: 11px'>
                            <li class="pladged">{formatCurrency(charity.pladged)}<span>Pledged</span></li>
